...
"}")
        ...
        self.horizontalLayout_2.addWidget(self.label_10, 0, QtCore.Qt.AlignLeft)
        ...
        self.horizontalLayout_2.addWidget(self.combo_box_share)
        ...
        self.line_edit_isin.setEnabled(False)
        ...
        self.gridLayout_5.addWidget(self.date_booking, 2, 1, 1, 1)
        self.total_amount = QtWidgets.QDoubleSpinBox(self.frame_7)
        self.total_amount.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.total_amount.setProperty("showGroupSeparator", True)
        self.total_amount.setMaximum(90000.0)
        self.total_amount.setObjectName("total_amount")
        self.gridLayout_5.addWidget(self.total_amount, 5, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.fee, 6, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.tax, 7, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.amount_per_share, 4, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.combo_box_type, 1, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.total_amount.setSuffix(_translate("Dialog", " €"))
        ...
        self.label_7.setText(_translate("Dialog", "Amount per share"))
        self.label_11.setText(_translate("Dialog", "Total amount"))
